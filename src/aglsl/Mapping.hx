...
class Mapping {
	static public var agal2glsllut(get_agal2glsllut, never) : Array<OpLUT>;

	static public var _agal2glsllut : Array<OpLUT>;
	static public function get_agal2glsllut() : Array<OpLUT>
	{

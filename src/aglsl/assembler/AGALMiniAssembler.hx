...
import aglsl.assembler.Part;
import aglsl.assembler.Opcode;
import aglsl.assembler.SamplerMap;
...
class AGALMiniAssembler
{
	...
	public function emitHeader( pr:aglsl.assembler.Part ) : Void
	{
	...
	public function emitOpcode( pr:aglsl.assembler.Part, opcode )
	{
		pr.data.writeUnsignedInt( opcode );
	}
	
	public function emitZeroDword( pr:aglsl.assembler.Part )
	{
	...
	public function emitDest( pr:aglsl.assembler.Part, token:String, opdest:String ) : Bool
	{
	...
	public function stringToMask( ?s:String ):UInt
	{
	...
	public function emitSampler( pr:Part, token:String, opsrc:FS, opts:Array<String> ) : Bool
	{
		...
		*/
		...
		{
			var o:aglsl.assembler.Sampler = SamplerMap.map.get( opts[i].toLowerCase() );
